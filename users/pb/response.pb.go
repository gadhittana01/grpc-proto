...
func (x *GetUsersResp) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *GetUsersResp) GetFullName() string {
	if x != nil {
		return x.FullName
	}
	return ""
...
func (x *GetUsersResp) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *GetUsersResp) GetCreatedAt() string {
	if x != nil {
		return x.CreatedAt
	}
	return ""
...
func (x *GetUsersResp) GetUpdatedAt() string {
	if x != nil {
		return x.UpdatedAt
	}
	return ""
...
var file_response_proto_rawDesc = []byte{
	...
	0x12, 0x02, 0x70, 0x62, 0x22, 0x8f, 0x01, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72,
	...
	0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
